      ...
      <div className="text-fluid--2 grid place-items-center gap-y-2 w-full">
        ...
        <div className="flex">
          <a
            ...
            href="https://www.linkedin.com/in/fatihdelice/"
          ...
          <a
            className="text-text-2 w-10 h-10 grid place-items-center rounded-md hover:bg-surface-4"
            href="https://twitter.com/intent/follow?screen_name=fatihdelice_"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-text-2 w-10 h-10 grid place-items-center rounded-md hover:bg-surface-4"
            href="https://instagram.com/delice.dev"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-text-2 w-10 h-10 grid place-items-center rounded-md hover:bg-surface-4"
            href="https://fatihdelice.medium.com/"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-text-2 w-10 h-10 grid place-items-center rounded-md hover:bg-surface-4"
            href="https://codepen.io/fatih-delice"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-text-2 w-10 h-10 grid place-items-center rounded-md hover:bg-surface-4"
            href="https://github.com/fatihdelice"
            rel="noopener noreferrer"
            target="_blank"
          ...
          >
            <svg fill="currentColor" className="w-7 h-5" viewBox="0 0 20 20" role="img">
              <title>Youtube</title>
